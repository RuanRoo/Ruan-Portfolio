          ...
          <>
            ...
            <div className="overflowHidden">
              <p className="dropSecond">
                ...
                opportunities and creative side of the industry while working
                full time as a workflow manager. At the start of 2022 I enrolled
                into a full stack web dev bootcamp at HyperionDev. I graduated
                at the top of my class after which I completed a 3 month
          ...
          <>
            <div className="overflowHidden">
              <p className="dropThird">
                ...
                create magic together. Although my passion is frontend
            ...
            <div className="overflowHidden">
              <p className="dropFourth">
                ...
                tutorials and walks in the park with my wife and golden
                retriever.
              </p>
            </div>
